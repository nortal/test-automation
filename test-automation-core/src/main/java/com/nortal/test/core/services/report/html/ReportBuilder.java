...
/**
 * Copy of {@link net.masterthought.cucumber.ReportBuilder}. This is a clean version, we're just changing method visibility to allow extensions.
 */
public class ReportBuilder {
	private static final Logger LOG = Logger.getLogger(net.masterthought.cucumber.ReportBuilder.class.getName());

	/**
	 * Page that should be displayed when the reports is generated. Shared between {@link FeaturesOverviewPage} and {@link ErrorPage}.
	 */
